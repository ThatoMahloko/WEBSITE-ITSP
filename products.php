    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Edit <b>Products</b></h2></div>
                    <div class="col-sm-4">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td>Wall Portrate</td>
                        <td>A portrate that covers a portion of a wall, SIZE 370cm X 400cm</td>
                        <td>555-2222</td>
                        <td>
                    ...
                    <tr>
                        <td>Coffee mug print out</td>
                        <td>A coffee mug with a printout of your desired image</td>
                        <td>555-5735</td>
                        <td>
                            <a class="add" title="Add" data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a>
                            <a class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                    ...
                    <tr>
                        <td>Tee-Shirt</td>
                        <td>A tee-shirt with a print out of your desired image</td>
                        <td>555-9931</td>
                        <td>
                            <a class="add" title="Add" data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a>
                            <a class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
